...
module.exports = (0, _vwx.Page)({
    ...
    onReady: function onReady() {
        ...
        wx.setStorage({
            key: "user", data: "good job", success: function success(_key, _data) {
                console.log(_key);
                console.log(_data);
            },
...
(0, _vwx.App)({
    pages: [{ path: '/index', component: _index2.default }, { path: '/cook', component: _index4.default }, { path: '/cook2', component: _index6.default }]
});
